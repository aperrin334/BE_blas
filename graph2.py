...
ax1.set_title("Evolution du temps moyen d'execution en fonction du nombre de THREAD de BLAS3")
...
ax1.set_title("Evolution de la rapidité de calcul (Gflop/S) en fonction du nombre de THREAD de BLAS3")
ax1.set_xlabel("Dimension")
ax1.set_ylabel("time (s)")
plt.legend()
plt.tight_layout()
